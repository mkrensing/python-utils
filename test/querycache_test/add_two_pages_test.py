...
jql = "project = TEST-A"
page_1 = JiraPageResult(start_at=0, total=20, issues=create_issues("TEST-A-", 0, 10))
page_2 = JiraPageResult(start_at=10, total=20, issues=create_issues("TEST-A-", 10, 10))
